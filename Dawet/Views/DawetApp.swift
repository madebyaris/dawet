    ...
    var body: some Scene {
        ...
        .commands {
            ...
            CommandGroup(after: .importExport) {
                Button("open.logs") {
                    DawetApp.openLogsFolder()
                }
                .keyboardShortcut("L", modifiers: [.command])
                Button("kill.bottles") {
                    DawetApp.killBottles()
                }
                .keyboardShortcut("K", modifiers: [.command, .shift])
                Button("wine.clearShaderCaches") {
                    DawetApp.killBottles() // Better not make things more complicated for ourselves
                    DawetApp.wipeShaderCaches()
                }
            }
