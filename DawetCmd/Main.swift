...
@main
struct Dawet: ParsableCommand {
    static let configuration = CommandConfiguration(
        abstract: "A CLI interface for Dawet.",
...
//            print("Create a bottle")
    ...
    struct Remove: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Remove an existing bottle from Dawet.",
    ...
    struct Run: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Run a program with Dawet.")
    ...
    struct Install: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Install DawetWine.")
    ...
    struct Uninstall: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Uninstall DawetWine.")

        @Flag(name: [.long, .short], help: "Uninstall DawetWine") var dawetWine = false
