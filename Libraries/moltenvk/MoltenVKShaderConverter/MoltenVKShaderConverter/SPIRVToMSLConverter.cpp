...
//	spvFile.close();
	...
	// can_compile_with_fast_math() was removed in newer SPIRV-Cross versions
	// Assume fast math is supported (default behavior)
	...
	// needs_texture_offset_buffer() was removed in newer SPIRV-Cross versions
	// Default to false (method no longer exists)
	conversionResult.resultInfo.needsTextureOffsetBuffer = false;
	...
	// needs_xfb_buffer() was removed in newer SPIRV-Cross versions
	// Default to false (method no longer exists)
	conversionResult.resultInfo.needsXfbBuffer = false;
